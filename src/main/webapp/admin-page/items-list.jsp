        ...
        <article class="content items-list-page">
            ...
            <div class="card item">
                <ul class="item-list striped" id="items">
                    ...
                    <%-- 2.1.	Web gọi đến ProductService lấy dữ liệu 6 sản phẩm đầu tiên. --%>
                    <%List<Product> products = ProductService.getInstance().loadProductWithConditionContainsStatus(1, 6, "0", "all", null, null, null, null);%>
                    <div id="appendItem">
<%-- 2.5.	Hiển thị danh sách 6 sản phẩm đầu tiên lên giao diện danh sách.--%>
...
reloadScript();
    ...
    // 2.6.	Chọn nút mũi tên trái hoặc phải ở giao diện để xem tiếp 6 sản phẩm trước đó hoặc tiếp theo.
    // Đây là trường hợp xem 6 sanr phẩm trước đó (nút mũi tên trái)
...
if (page > 0) {
$.ajax({
    // 2.6.1.	Gọi đến lớp xử lý LoadProductListAdminProduct yêu cầu hiển thị 6 sản phẩm.
...
reloadScript();
    ...
    // Đây là trường hợp xem 6 đơn hàng tiếp theo đó (nút mũi tên phải)
