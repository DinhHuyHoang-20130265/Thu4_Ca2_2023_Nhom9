...
<%@ page import="beans.ProductColor" %>
<%@ page import="beans.ProductImage" %>
<%@ page import="beans.ProductReview" %>
<%@ page import="beans.ProductSale" %>
<%@ page import="beans.ProductSize" %>
<%@ page import="DAO.ProductReviewDAO" %>
<%@ page import="java.util.List" %>
<%@ page import="beans.UserInformation" %>
<%@ page import="DAO.UserInformationDAO" %>
<%@ page import="DAO.CategoryDAO" %>
<%@ page import="services.ProductReviewService" %>
