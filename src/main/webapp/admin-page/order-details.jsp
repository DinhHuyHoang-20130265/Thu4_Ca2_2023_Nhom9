...
<%@ page import="services.OrderDetailService" %>
<%@ page import="services.OrderService" %>
<%@ page import="beans.order.OrderDetail" %>
...
<div class="main-wrapper">
    <div class="app" id="app">
        ...
        <article class="content items-list-page">
            ...
            <%-- 4.1.	Web Gọi đến OrderDetailService lấy dữ liệu cho chi tiết đơn hàng tương ứng. --%>
            <%
            ...
            %>
            <%-- 4.5.	Hiển thị chi tiết đơn hàng lên giao diện chi tiết đơn hàng. --%>
            <div>
...
<script>
    // 5.	Admin kiểm tra các trạng thái, thay đổi các trạng thái cần được cập nhật.
    const id = $("#ordId").val();
    // 5.1.	Thay đổi trạng thái xác nhận đơn hàng, gọi đến lớp UpdateOrderController.
        ...
        $(".yes").click(function () {
            if (parseInt($("#isCanceled-status").val()) === 0) {
                ...
                $.ajax({
                    ...
                    //9.	Lớp xử lý Hiển thị thông báo cập nhật thành công, đồng thời cập nhật lại giao diện chi tiết đơn hàng tương ứng.
                    success: function () {
                        $("#order-status").val("1")
    ...
    // 5.2.	Thay đổi trạng thái vận chuyển đơn hàng, gọi đến lớp UpdateOrderController.
    ...
    //5.3.	Thay đổi trạng thái thanh toán đơn hàng, gọi đến lớp UpdateOrderController.
