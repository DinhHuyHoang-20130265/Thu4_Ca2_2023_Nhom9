...
public class UpDownImageNewsController extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        File filesDir = (File) getServletContext().getAttribute("FILES_DIR_TEMPNEWS");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        File file = new File(request.getServletContext().getAttribute("TEMPNEWS_DIR") + File.separator + fileName);
        if (!file.exists()) {
            throw new ServletException("File doesn't exist");
        }
        response.sendRedirect(request.getServletContext().getAttribute("TEMPNEWS_DIR") + File.separator + fileName);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            while (fileItemIterable.hasNext()) {
                ...
                File file = new File(request.getServletContext().getAttribute("TEMPNEWS_DIR") + File.separator + fileItem.getName());
                fileItem.write(file);
            }
